...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2020 at 09:48 AM
...
(1, 'admin@admin.com', '827ccb0eea8a706c4c34a16891f84e7b', '2017-01-24 16:21:18', '21-06-2018 08:27:55 PM');
...
(1, 0, 4, 'Hi', '2020-08-04 07:41:20', 1),
(2, 4, 5, 'how can I help u ?', '2020-08-04 07:42:15', 2),
(3, 0, 4, 'hie', '2020-08-04 07:44:28', 2),
(4, 0, 5, 'how can I help u?', '2020-08-04 07:45:37', 1),
(5, 4, 5, 'hiee', '2020-08-04 07:46:14', 0),
(6, 5, 4, 'how can i help u?', '2020-08-04 07:46:33', 0);
...
(4, 'pragya', '$2y$10$EZNcN6S4krrYJZVDfne2QuEhXwrgozpbd/2dmQH4fIKLUaEPQXzQW'),
(5, 'admin', '$2y$10$tYl0.uL1JhLwW45lK9pWtO61WJ2.fpOR31vAAkFWvYco9pbHf3i2O');
...
(1, 4, '2020-08-04 07:46:49', 'no'),
(2, 5, '2020-08-04 07:46:44', 'no');
...
CREATE TABLE `orders` (
  ...
  `addedby` varchar(100) CHARACTER SET swe7 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `orders` (`id`, `userId`, `productId`, `quantity`, `orderDate`, `paymentMethod`, `orderStatus`, `addedby`) VALUES
(1, 1, '3', 1, '2017-03-07 19:32:57', 'COD', NULL, ''),
(3, 1, '4', 1, '2017-03-10 19:43:04', 'Debit / Credit card', 'Delivered', ''),
(4, 1, '17', 1, '2017-03-08 16:14:17', 'COD', 'in Process', ''),
(5, 1, '3', 1, '2017-03-08 19:21:38', 'COD', NULL, ''),
(6, 1, '4', 1, '2017-03-08 19:21:38', 'COD', NULL, ''),
(7, 1, '2', 3, '2020-06-03 15:28:30', 'Debit / Credit card', NULL, ''),
(8, 5, '23', 1, '2020-07-08 09:01:38', 'COD', 'Delivered', 'seller12');
...
INSERT INTO `ordertrackhistory` (`id`, `orderId`, `status`, `remark`, `postingDate`, `track_id`, `courier_name`) VALUES
(1, 3, 'in Process', 'Order has been Shipped.', '2017-03-10 19:36:45', '', ''),
(2, 1, 'Delivered', 'Order Has been delivered', '2017-03-10 19:37:31', '', ''),
(3, 3, 'Delivered', 'Product delivered successfully', '2017-03-10 19:43:04', '', ''),
(4, 4, 'in Process', 'Product ready for Shipping', '2017-03-10 19:50:36', '', ''),
(5, 8, 'Delivered', 'satisfactory', '2020-07-08 09:02:37', '', '');
...
CREATE TABLE `seller` (
  ...
  `alternate_phone` varchar(100) CHARACTER SET latin1 NOT NULL,
  `email` varchar(60) CHARACTER SET latin1 NOT NULL,
  `password` varchar(100) CHARACTER SET latin1 NOT NULL,
  `address` varchar(20) CHARACTER SET latin1 NOT NULL,
  `bank_account_number` varchar(40) CHARACTER SET latin1 NOT NULL,
  `bank_ifsc` varchar(20) CHARACTER SET latin1 NOT NULL,
  `beneficiary_name` int(40) NOT NULL,
  `voter_id` varchar(15) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `seller` (`id`, `name`, `phone`, `alternate_phone`, `email`, `password`, `address`, `bank_account_number`, `bank_ifsc`, `beneficiary_name`, `voter_id`) VALUES
(3, 'seller12', '1234567890', '2345678903', 'seller@seller12.com', '827ccb0eea8a706c4c34a16891f84e7b', 'india', 'DILDSA123', 'KLAHGOE1234', 4, 'JREH7899');
...
INSERT INTO `sellerlogin` (`id`, `username`, `password`, `creationDate`, `updateDate`) VALUES
(1, 'seller@seller.com', '827ccb0eea8a706c4c34a16891f84e7b', '2020-07-08 08:20:19', '8/7/2020');
...
(24, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:24:54', NULL, 0),
(25, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:25:14', NULL, 0),
(26, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:25:46', NULL, 0),
(27, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:26:04', NULL, 0),
(28, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:27:01', NULL, 0),
(29, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:27:14', NULL, 0),
(30, 'anuj.lpu1@gmail.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:27:32', NULL, 0),
(31, 'anuj.lpu1@gmail.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:28:00', '03-06-2020 09:18:13 PM', 1),
(32, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-06-03 15:48:44', NULL, 0),
(33, 'anuj.lpu1@gmail.com', 0x3a3a3100000000000000000000000000, '2020-06-04 09:44:21', NULL, 1),
(34, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-07-01 16:46:33', NULL, 0),
(35, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-07-01 16:46:40', NULL, 0),
(36, 'admin@admin.com', 0x3a3a3100000000000000000000000000, '2020-07-04 10:00:23', NULL, 0),
(37, 'admin@admin123.com', 0x3a3a3100000000000000000000000000, '2020-07-04 10:04:19', NULL, 1),
(38, 'priya@gmail.com', 0x3a3a3100000000000000000000000000, '2020-07-08 09:00:17', NULL, 1);
...
(4, 'admin123', 'admin@admin123.com', 1234567891, '0192023a7bbd73250516f069df18b500', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-07-04 10:03:07', NULL),
(5, 'priya', 'priya@gmail.com', 2345678901, '796905f1fa2df364520f9829310a8797', 'indra nagar', 'up', 'rampur', 243001, 'indra nagar', 'up', 'rampur', 243001, '2020-07-08 08:59:33', NULL);
